...
import alma.fr.strategychoicecomponents.HashStrategyChoice;
...
public class LSEQhashModule implements Module {
	...
	public void configure(Binder binder) {
		...
		binder.bind(IStrategyChoice.class).to(HashStrategyChoice.class);
	}
